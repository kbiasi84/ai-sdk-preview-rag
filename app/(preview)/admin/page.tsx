      ...
      <div className="flex justify-center items-center min-h-screen bg-neutral-50 dark:bg-neutral-900">
        <div className="w-full max-w-md p-8 bg-white dark:bg-neutral-800 rounded-lg shadow-md">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label htmlFor="password" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                Senha
              </label>
              <Input
                id="password"
        ...
        <div className="bg-white dark:bg-neutral-800 rounded-lg shadow-sm p-6 mb-8">
          ...
          {activeTab === "text" ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="title" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  Título (opcional)
                </label>
                <Input
                  id="title"
              ...
              <div>
                <label htmlFor="content" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  Conteúdo
                </label>
                <Textarea
                  id="content"
                ...
                <p className="text-xs text-gray-500 mt-1 dark:text-neutral-400">
                  Para melhor processamento, insira textos completos e bem formatados.
                </p>
              </div>
              <Button type="submit" disabled={isSubmitting || !content.trim()}>
                {isSubmitting ? "Processando..." : "Adicionar à Base de Conhecimento"}
              </Button>
            </form>
          ) : activeTab === "pdf" ? (
            <form onSubmit={handlePdfUpload} className="space-y-4">
              <div>
                <label htmlFor="pdf-file" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  Arquivo PDF
                </label>
              ...
              <Button type="submit" disabled={isUploadingPdf || !pdfFile}>
                {isUploadingPdf ? "Processando..." : "Processar PDF e Adicionar"}
              </Button>
            </form>
          ) : (
            <form onSubmit={handleLinkSubmit} className="space-y-4">
              <div>
                <label htmlFor="link-url" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  URL
                </label>
                <Input
                  id="link-url"
              ...
              <div>
                <label htmlFor="link-title" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  Título
                </label>
                <Input
                  id="link-title"
              ...
              <div>
                <label htmlFor="link-description" className="block text-sm font-medium mb-2 dark:text-neutral-200">
                  Descrição (opcional)
                </label>
                <Textarea
                  id="link-description"
                ...
                />
                <p className="text-xs text-gray-500 mt-1 dark:text-neutral-400">
                  A página será acessada automaticamente e seu conteúdo será extraído para a base de conhecimento.
                </p>
              </div>
              <Button type="submit" disabled={isSubmittingLink || !linkUrl.trim() || !linkTitle.trim()}>
                {isSubmittingLink ? "Processando..." : "Adicionar Link e Extrair Conteúdo"}
              </Button>
            </form>
          )}
        </div>
                    ...
                    <div className="flex justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-2">
                          Última atualização:{" "}
                          {new Date(link.lastProcessed).toLocaleDateString("pt-BR", {
                            day: "2-digit",
                            month: "2-digit",
                            year: "numeric",
                            hour: "2-digit",
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        >
                          {isRefreshingLink === link.id ? "Atualizando..." : "Atualizar Agora"}
                        </Button>
                        <Button
                          variant="destructive"
                          size="sm"
